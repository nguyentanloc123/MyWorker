...
class ViewPagerAapter (private val imgCoffeSlides:List<ImageCoffeSlide>) : RecyclerView.Adapter<ViewPagerAapter.ViewPagerAapterViewHolder>(){
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ViewPagerAapter.ViewPagerAapterViewHolder {
       return ViewPagerAapterViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.viewpagerlist,parent,false))
    }
    ...
    override fun onBindViewHolder(
        holder: ViewPagerAapter.ViewPagerAapterViewHolder,
        position: Int
    ) {
