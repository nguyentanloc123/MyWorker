...
class ThoInfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        usernameUser = sharedPref.getString(getString(R.string.usernameUser), "loc dep trai").toString()
...
//            usersdRef.addListenerForSingleValueEvent(eventListener)
    ...
    fun loadDataTho(idTho: String)
    {
        ...
        val tensuachua = sharedPref2.getString(getString(R.string.tensuachua), "loc dep trai")
